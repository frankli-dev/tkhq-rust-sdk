...
impl serde::Serialize for DeleteSubOrganizationRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("external.activity.v1.DeleteSubOrganizationRequest", len)?;
        if true {
            struct_ser.serialize_field("type", &self.r#type)?;
        }
        if true {
...
impl<'de> serde::Deserialize<'de> for DeleteSubOrganizationRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DeleteSubOrganizationRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct external.activity.v1.DeleteSubOrganizationRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DeleteSubOrganizationRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut r#type__ = None;
                ...
                Ok(DeleteSubOrganizationRequest {
                    r#type: r#type__.unwrap_or_default(),
                    timestamp_ms: timestamp_ms__.unwrap_or_default(),
                    organization_id: organization_id__.unwrap_or_default(),
                    parameters: parameters__,
        ...
        deserializer.deserialize_struct("external.activity.v1.DeleteSubOrganizationRequest", FIELDS, GeneratedVisitor)
    }
}
